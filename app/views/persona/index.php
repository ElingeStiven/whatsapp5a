...
<div class="container">
    ...
    <a href="/whatsapp5a/app/views/persona/create.php"><button>Agregar</button></a>
                ...
                <?php foreach ($personas as $persona): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($persona['nombre_sexo']); ?></td> <td><?php echo htmlspecialchars($persona['nombre_estadocivil']); ?></td> <td>
                            <a href="/whatsapp5a/public/persona/editForm?id=<?php echo htmlspecialchars($persona['idpersona']); ?>">
                                <button>Editar</button>
                            </a>
                            <a href="/whatsapp5a/public/persona/deleteForm?id=<?php echo htmlspecialchars($persona['idpersona']); ?>"
