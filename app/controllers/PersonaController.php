...
require_once $_SERVER['DOCUMENT_ROOT'] . '/whatsapp5a/app/models/Persona.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/whatsapp5a/app/models/Sexo.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/whatsapp5a/app/models/Estadocivil.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/whatsapp5a/app/models/Direccion.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/whatsapp5a/app/models/Telefono.php';
